<x-frontend-layout>
    ...
    <div class="relative">
        <img class="w-full object-cover brightness-50 filter lg:h-[500px]" src="storage/product/header-bg.6b2a5943.jpeg"
    ...
    <section class="container flex flex-col justify-center gap-3 mx-auto my-8 lg:flex-row">
        ...
        <div class="flex flex-row items-center justify-center px-5 py-4 mx-5 border-2 border-yellow-400">
            ...
            <div class="flex flex-col justify-center ml-6">
                <h3 class="text-xs font-bold text-left lg:text-sm">Free Delivery</h3>
        ...
        <div class="flex flex-row items-center justify-center px-5 py-4 mx-5 border-2 border-yellow-400">
            ...
            <div class="flex flex-col justify-center ml-6">
                <h3 class="text-xs font-bold text-left lg:text-sm">Money returns</h3>
        ...
        <div class="flex flex-row items-center justify-center px-5 py-4 mx-5 border-2 border-yellow-400">
            ...
            <div class="flex flex-col justify-center ml-6">
                <h3 class="text-xs font-bold text-left lg:text-sm">24/7 Supports</h3>
                <p class="text-xs text-left text-light lg:text-sm">
                    Consumer support
                </p>
            </div>
    ...
    <div class="mx-auto max-w-[1200px] px-5">
        <section class="mt-10 flex max-w-[1200px] justify-between bg-violet-900 px-5">
            <div class="px-3 py-8 lg:px-16">
                ...
                <button href="#" class="px-4 py-2 mt-6 duration-100 bg-amber-400 hover:bg-yellow-300">
                    Shop now
                </button>
            </div>
    ...
    <div>
                    ...
                    {{-- <div class="flex flex-col">
                        <div class="relative flex">
                            ...
                            <div
                                ...
                                <a href="/product-overview.html">
                                    <span
                                        class="flex items-center justify-center w-8 h-8 rounded-full cursor-pointer bg-amber-400">
                        ...
                        <div>
                            ...
                            <p class="font-medium text-violet-900">
                                {{ $product->price }}
                                <span
                                    class="text-sm text-gray-500 line-through">{{ $product->price + $product->discount }}</span>
                            </p>
                            ...
                            <div>
                                <button class="w-full h-10 my-5 text-white bg-violet-900" value="{{ $product->id }}"
                                    x-on:click='$parent.save($event.target.value)'>
                                    Add to cart
                                </button>
                            </div>
                        </div>
        ...
        {{-- <!-- New Products --> --}}
        <div>
            <p class="mx-auto mt-10 mb-5 max-w-[1200px] px-5">New Products</p>
            <section class="mx-auto grid max-w-[1200px] grid-cols-2 gap-3 px-5 pb-10 lg:grid-cols-4">
                @foreach ($new_products as $np)
                    <x-products :product="$np" />
                @endforeach
            </section>
        </div>
        {{-- <!-- /New Product --> --}}
        ...
        {{-- <!-- Feature Products --> --}}
        <div>
            <p class="mx-auto mt-10 mb-5 max-w-[1200px] px-5">Feature Products</p>
            <section class="mx-auto grid max-w-[1200px] grid-cols-2 gap-3 px-5 pb-10 lg:grid-cols-4">
                @foreach ($features as $fp)
                    <x-products :product="$fp" />
                @endforeach
            </section>
        </div>
        {{-- <!-- /Feature Product --> --}}

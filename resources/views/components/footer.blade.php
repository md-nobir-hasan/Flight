   <!-- Desktop Footer  -->
    ...
    <footer class="mx-auto w-full max-w-[1200px] justify-between pb-10 flex flex-col lg:flex-row">
        <div class="ml-5">
            <img class="mt-10 mb-5" src="storage/product/company-logo.3dc1d5f6.svg" alt="company logo">
            <p class="pl-0">
    ...
    <section class="h-11 bg-amber-400">
        <div class="mx-auto flex max-w-[1200px] items-center justify-between px-4 pt-2">
            ...
            <div class="flex items-center space-x-3">
                ...
                <img class="h-8" src="https://cdn-icons-png.flaticon.com/512/5968/5968144.png"
                    alt="Apple pay icon">
            </div>
        </div>
    </section>
 ...
 <script src="{{ asset('asset/frontend/js/script.js') }}" defer=""></script>
